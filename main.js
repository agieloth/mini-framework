...
//   return {
//     tag: 'div',
//     children: ['Bienvenue à l’accueil']
//   };
// }
...
//   return {
//     tag: 'div',
//     children: ['À propos de mon framework']
//   };
// }
...
//         tag: 'button',
//         events: {
//           click: () => alert('Tu as cliqué via le système d’événements custom !')
//         },
//         children: ['Clique-moi']
//       }
//     ]
...
// // Combinaison dans une page unique
// function HomePage() {
//   return {
//     tag: 'div',
//     children: [
...
//       MyButton({
//         label: 'Clique ici',
//         onClick: () => alert('Tu as cliqué sur un composant !')
//       })
//     ]
//   };
// }
...
// // Démarre le système de routing
// App.startRouting();

// // Mise à jour lors de changement de state
// store.subscribe(() => {
